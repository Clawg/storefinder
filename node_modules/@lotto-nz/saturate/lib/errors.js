...
exports.TimeoutError = exports.ApiError = exports.RequestError = exports.InternalError = exports.InvalidActionError = undefined;
 ...
 */
var InvalidActionError = function (_Error) {
  (0, _inherits3.default)(InvalidActionError, _Error);

  function InvalidActionError(validationErrors) {
    (0, _classCallCheck3.default)(this, InvalidActionError);

    var _this = (0, _possibleConstructorReturn3.default)(this, (InvalidActionError.__proto__ || (0, _getPrototypeOf2.default)(InvalidActionError)).call(this));

    _this.name = 'InvalidActionError';
    _this.message = 'Invalid Action';
...
var TimeoutError = function (_Error5) {
  (0, _inherits3.default)(TimeoutError, _Error5);

  function TimeoutError(message) {
    (0, _classCallCheck3.default)(this, TimeoutError);

    var _this5 = (0, _possibleConstructorReturn3.default)(this, (TimeoutError.__proto__ || (0, _getPrototypeOf2.default)(TimeoutError)).call(this));

    _this5.name = 'TimeoutError';
