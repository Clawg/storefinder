...
function isValidTypeDescriptor(obj) {
  ...
  if (typeof obj.type !== 'string' && (0, _typeof3.default)(obj.type) !== 'symbol') {
    return false;
  }
...
function validateRSAA(action) {
  ...
  var validCallAPIKeys = ['endpoint', 'timeout', 'method', 'body', 'headers', 'credentials', 'bailout', 'types'];
  ...
  if (typeof credentials !== 'undefined') {
    if (typeof credentials !== 'boolean') {
      validationErrors.push('[CALL_API].credentials property must be undefined, or a boolean');
    }
  }
